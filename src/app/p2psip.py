...
class AbstractAgent(object):
    ...
    def __init__(self, sipaddr=('127.0.0.1', 5060), stack=Stack):
...
class Agent(AbstractAgent):
    ...
    def __init__(self, server=False, sipaddr=('127.0.0.1', 5060), port=0):
...
if __name__ == '__main__':
    ...
    parser.add_option('-p', '--sip-port',dest='sip_port', default=5060, type="int", help='SIP port number to listen. default is 5062.')
